...
public class ModeleFrancais extends Wordle{	
	...
	//paramètres
	int nbVoyellesDepart=3;
	double toleranceTour1 =0;
	double toleranceTour2 =0.01;
	double toleranceTour3 =0.01;
	double toleranceTour4 =0.005;
	double toleranceTour5 =0;
	...
	public String obtainValidUserWord(char[][][] entry) {
		...
		switch (entry.length) {
		case 1:
			return tour1(toleranceTour1);
		case 2:
			return tour2(toleranceTour2);
		case 3:
			return tour345(toleranceTour3);
		case 4:
			return tour345(toleranceTour4);
		case 5:
			return tour345(toleranceTour5);
		default:
			return tour345(1);
	...
	private String tour1(double tolerence) {
		...
		}while(nbVoyelle<nbVoyellesDepart);
	...
	private String tour345(double tolerence) {
